...
<h2> <a href="{{site.url}}/assets/pdfs/CV_Chen.pdf"><span style="text-decoration: underline;">CV</span></a><a href="{{site.url}}/research.html"><span style="text-decoration: underline; padding:30px">Research</span></a><a href="{{site.url}}/teaching.html"><span style="text-decoration: underline;">Teaching</span></a></h2>
...
<table border="0">
 <tr>
    <td>
      ...
      Contact: <b>yixinchen@ucsb.edu, elainechen1239@gmail.com</b>
    </td>
